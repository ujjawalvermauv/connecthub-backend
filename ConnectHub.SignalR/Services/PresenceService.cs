...
using ConnectHub.SignalR.Models;

namespace ConnectHub.SignalR.Services
{
    public class PresenceService : IPresenceService
    {
        ...
        {
            return _connections.Keys.OrderBy(id => id).ToList();
        }
        ...
        public List<UserConnection> GetOnlineUsersInfo()
        {
            return _connectionInfo.Values
                ...
                .Select(group => group.OrderByDescending(connection => connection.ConnectedAt).First())
