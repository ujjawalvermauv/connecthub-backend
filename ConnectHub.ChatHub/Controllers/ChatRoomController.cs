    ...
    public class ChatRoomController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateRoom([FromBody] ChatRoom room)
        {
            try
            {
                ...
                return CreatedAtAction(nameof(GetRoomById), new { roomId = created.RoomId }, created);
            }
        ...
        [HttpPut("{roomId:int}")]
        public async Task<IActionResult> UpdateRoom([FromRoute] int roomId, [FromBody] ChatRoom room)
        {
            try
            {
                var updated = await _roomService.UpdateRoom(roomId, room);
        ...
        public async Task<IActionResult> RemoveMember([FromQuery] int roomId, [FromQuery] int userId)
        {
